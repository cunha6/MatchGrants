...
_SYSTEM = (
    ...
    "O campo \"reason\" é SEMPRE OBRIGATÓRIO, nos dois casos. Nunca devolvas null.\n"
    ...
    "ou \"sim\" sozinha.\n"
    "Quando \"adequate\": false, diz CONCRETAMENTE onde está o desencontro — que tipo de "
    "entidade ou atividade o aviso exige, e porque é que a empresa não corresponde. Nunca "
    "uma frase vaga como \"não é adequado\" ou \"não se enquadra\" sozinha. "
    "Ex.: \"Financia a criação de áreas de acolhimento empresarial, dirigido a quem constrói "
    "as infraestruturas, não a uma indústria que as ocuparia.\"\n"
    ...
    "aviso. Ex.: \"Digitalização dos processos de "
    ...
    "\"reason\": \"<justificação obrigatória, ver regras acima>\"}]\n"
