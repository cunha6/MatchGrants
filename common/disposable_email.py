...
def is_disposable_email(email: str) -> bool:
    ...
    isso é responsabilidade de quem chama (ver _missing_contact_fields, que valida o formato
    antes). `str()` porque o valor vem do corpo JSON do cliente e pode não ser uma string
    (ex: {"email": 123}) — aí não há domínio a comparar e a resposta é simplesmente False."""
